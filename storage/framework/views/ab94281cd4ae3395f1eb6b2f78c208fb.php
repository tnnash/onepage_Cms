            ...
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="p-6 bg-gray-50 rounded-lg shadow-md">
                    <div class="flex items-center justify-center space-x-4">
                        <img src="<?php echo e($testimonial->client_image); ?>" alt="<?php echo e($testimonial->client_name); ?>" class="w-16 h-16 rounded-full">
                        <div>
                            <h4 class="text-lg font-semibold text-gray-800"><?php echo e($testimonial->client_name); ?></h4>
                            <p class="text-sm text-gray-500"><?php echo e($testimonial->client_position); ?></p>
                        </div>
                    </div>
                    ...
                    <p class="text-blue-500 italic mb-4">"<span class="text-black"><?php echo e($testimonial->testimonial); ?></span>"</p>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
        </div>
    </div>
</section>
<?php /**PATH /var/www/html/onepage-cms/resources/views/livewire/testimonials.blade.php ENDPATH**/ ?>